...
public class AlternativeExecutionTime
{
    ...
    {
        // timeUnit is hourly, daily
        // alternativeExecutionTime is set
        // alternativeExecutionTime has passed
        if (!TimeUnit.SINGULAR.equals(timeUnit) &&
            null != alternativeExecutionTime &&
            alternativeExecutionTime.before(new Date())) {
